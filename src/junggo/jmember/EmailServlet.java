	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		multi = new MultipartRequest(req, upload, size, encode, new DefaultFileRenamePolicy());
		 ...
		 resp.setContentType("text/html;charset=utf-8");
            ...
            JMemberVo vo = dao.findPwd(mid, irum, receiver);
		    ...
		    if(vo != null){ 
		          ...
		          try {
		              ...
		              text.setContent(vo.getPwd(), "text/html;charset=utf-8");
		          ...
		          // resp.getWriter().print("<script>alert('회원님의 암호를 이메일로 전송하였습니다.')</script>");
